...
namespace BIOMETRICS_JULY
{
    public partial class Home : Form
    {
        ...
        private void enrollFingerprintsToolStripMenuItem1_Click_1(object sender, EventArgs e)
        {
            Enrolment ee = new Enrolment();
            ee.ShowDialog();
        }

        private void attendanceTimeOutToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
             ClockOut form = new ClockOut();
             form.ShowDialog();
        }
